...
<div class="row">
	...
	<h1>Reportes de Créditos</h1>
						...
						<form>
						<input type="hidden" name="view" value="creditbuyreports">
<div class="row">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
			...
			if($_GET["client_id"]==""){
			$operations = CreditoData::getAllCreditBuyByDateOp($_GET["sd"],$_GET["ed"],2);
			}
			else{
			$operations = CreditoData::getAllCreditBuyByDateBCOp($_GET["client_id"],$_GET["sd"],$_GET["ed"],2);
			} 
