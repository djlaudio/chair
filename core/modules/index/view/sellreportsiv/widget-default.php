...
<div class="row">
	...
	<h1>Reportes de Ventas Timbradas</h1>



						<form>

						<input type="hidden" name="view" value="sellreportsiv">
...
<?php if($_GET["sd"]!=""&&$_GET["ed"]!=""):?>
			...
			$operations = SellData::getAllByDateOpIV($_GET["sd"],$_GET["ed"],2,1);

			}

			else{

			$operations = SellData::getAllByDateBCOpIV($_GET["client_id"],$_GET["sd"],$_GET["ed"],2,1);
